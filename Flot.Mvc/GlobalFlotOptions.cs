...
namespace Flot.Mvc
{
    public abstract class GlobalFlotOptions
    {
        /// <summary>
        /// Gets or sets whether to animate the flot.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether or not the flot should be responsive and resize when the browser does.
        /// </summary>
